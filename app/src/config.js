...
module.exports = {
    ...
    chatGPT: {
        ...
        */
        enabled: true,
        apiKey: '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',
    ...
    mediasoup: {
        ...
        webRtcTransport: {
            listenIps: [
                {
                    ip: '0.0.0.0',
                    announcedIp: '5.161.220.206', // replace by 'public static IPV4 address' https://api.ipify.org (type string --> 'xx.xxx.xxx.xx' not xx.xxx.xxx.xx)
